...
> 本基线主要为了学习交流学习使用，请勿直接用于相关的商业，如有需求，请跟作者联系。部分图片为网上获取，如有侵权，请说明

### 建设愿景

很多企业在转型中台架构，看到的资料和成体系的都比较少，包括整体的落地思路和文档等，都相对比较少，这里规划了从政策、行业、战略、团队、架构、产品、技术、项目、业务、开发等一整体的内容，涵盖技术点前端、后台、容器、自动化、大数据、运维监控等，维护一套就可以。
...
> 中台更多的是架思维，体系参考多个开源项目，从 DDD 架构思想进行规划和建设，融合多个成熟开源产品进行整合和输出，不需要从零开始
