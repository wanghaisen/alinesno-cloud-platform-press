    ...
    <div class="container">
      <div class="row footer-row">
        <div class="col-md-3">
          ...
          <p class="footer-text" style="text-indent: 24px">
            企业级数字化研发团队，专注南宁网站建设,南宁网站制作,
            南宁网页设计,拥有10年南宁网站建设团队开发经验，
            拥有5000余成功案例!，alinesno-platform是软件基础平台
            与解决方案，致力面向企事业单位及软件开发商提供基于
            JAVA的基础平台及解决方案。
          </p>
        </div>
        <div class="col-md-3">
          ...
          >
            <a href="javascript:void(0);"> alinesno-cloud企业版 </a>
          </p>
          <p
            class="footer-text-product"
            style="
          ...
          >
            <a href="javascript:void(0);"> alinenso-cloud技术中台 </a>
          </p>
          <p
            class="footer-text-product"
            style="
          ...
          <p class="footer-text-product">
            <a href="javascript:void(0);"> alinenso-boot 2.1.0 </a>
          </p>
          <p
            class="footer-text-product"
            style="
          ...
          <p class="footer-text-product">
            <a href="javascript:void(0);"> alinenso-cat 2.1.0 </a>
          </p>
          <p
            class="footer-text-product"
            style="
          ...
          <p class="footer-text-product">
            <a href="javascript:void(0);"> alinenso-generator 1.0 </a>
          </p>
          <p
            class="footer-text-product"
            style="
        ...
        <div class="col-md-3">
          ...
          <p class="footer-text-product" style="padding-top: 10px">
            ...
            <a href="javascript:void(0);"> 支付宝在线支付 </a>
          </p>
          <!--<p class="footer-text-product"><i class="iconfont icon-dianhua1"></i> 18774035187</p>-->
          <p class="footer-text-product">
            <i class="iconfont icon-duigongzhanghu"> </i>
            <a href="javascript:void(0);"> 企业账号汇款 </a>
          </p>
        </div>
        <div class="col-md-3">
      ...
      <div class="footer-copyright" style="font-size: 13px">
        版权所有 ©
